 ...
 *   og skriver dette ut igjen p� skjermen.
 *
 *   @file    OPPG_05.CPP
 ...
 *
 *  @param     f  - Forelesning-struct som f�r sine datamedlemmer oppdatert
 */
void forelesningLesData(Forelesning* f)  {
 ...
 *
 *  @param     f  - Forelesning-struct som f�r sine datamedlemmer skrevet ut
 */
void forelesningSkrivData(const Forelesning* f)  {
    cout << '\t' << f->timeStart << ':'

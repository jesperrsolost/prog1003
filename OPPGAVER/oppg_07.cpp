 ...
 *   vha. overloadede funksjoner og referanseoverf�ring.
 *
 *   @file    OPPG_07.CPP
 ...
 *
 *  @param  s  - string som fylles med tekst (referanseoverf�rt)
 */
void les(string & s)  {
    do {
 ...
 *
 *  @param  klokkeslett  - som fylles med ALLE data (referanseoverf�rt)
 */
void les(Klokkeslett & klokkeslett)  {
 ...
 *
 *  @param  klokkeslett  - som f�r skrevet ut ALLE sine data
 */
void skriv(const Klokkeslett klokkeslett)  {  // Legger evt. p� startende '0':
